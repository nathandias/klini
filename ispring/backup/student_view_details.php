                            ...
                            <p class="tooltip">
                                ...
                                <input type="submit" class="logout-btn" name="logout" value="Logout">
                                    ...
                                    if(isset($_POST['logout']))
                                    {
                                        ...
                                        unset($_SESSION["pass"]);
                                        session_destroy();  
                                        echo "<script type='text/javascript'>document.location.href='https://wordparts.net/ispring/';</script>";
                                    }
                                    ?>
                               </span>
                            </form>
                ...
                <div class="container">
                    <div class="view-details-inner">
                        <div class="table-header flex">
                            <h1 class="text-23">Student Standing</h1>
                            <div class="search-pad relative flex">
                                ...
                                <button class="btn-primary btn-4 btn com-hover" id="downloadPDF"><span>Expert as PDF</span></button>
                            </div>
                        </div>
                        <div class="student-profile" id="studentDetails">
                            <div class="lt-part">
                                <div class="header-view-details">
                                    <p>
                                        <span><i class="fas fa-user"></i></span> Student Information
                                    </p>
                                </div>
                                ...
                                <div class="student-infos flex">
                                    ...
                                    <div class="inner-section sec-one flex width-half" id="mydiv" data-myval="<?php echo $FIRST_NAME."_".$LAST_NAME; ?>">
                                        <div class="left">
                                            <p class="label-p">First Name</p>
                                        </div>
                                        <div class="right">
                                            <p class=""><?php echo $FIRST_NAME; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner-section sec-one flex width-half">
                                        <div class="left">
                                            <p class="label-p">Last Name</p>
                                        </div>
                                        <div class="right">
                                            <p class=""><?php echo $LAST_NAME; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner-section sec-one flex width-half">
                                        <div class="left">
                                            <p class="label-p">Date of Birth</p>
                                        </div>
                                        <div class="right">
                                            <p class=""><?php echo $DOB; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner-section sec-one flex width-half">
                                        <div class="left">
                                            <p class="label-p">Phone Number</p>
                                        </div>
                                        <div class="right">
                                            <p class=""><?php echo $PHONE; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner-section sec-one flex width-half">
                                        <div class="left">
                                            <p class="label-p">Pre-registration No.</p>
                                        </div>
                                        <div class="right">
                                            <p class=""><?php echo $PRN; ?></p>
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
                            ...
                            <div class="lt-part">
                                <div class="header-view-details">
                                    <p>
                                        <span><i class="fas fa-graduation-cap"></i></span> Course Details
                                    </p>
                                </div>
                                    ...
                                    <table class="main-student-table">
                                        ...
                                        <tbody>
                                            <?php foreach ($array1 as $Details => $result) { 
                                                if($id==$userId[$Details]){ ?>
                                                    <tr>                                                
                                                        <td> <?php echo $courseTitle[$Details]; ?></td>
                                                        <td> <?php echo date_format($s_date[$Details],"Y-m-d"); ?></td>
                                                        <td> <?php if(!empty($result['completionDate'])) { echo date_format($e_date[$Details],"Y-m-d"); } else { echo $completionDate[$Details]; } ?></td>
                                                        <td> <?php echo $completionStatus[$Details]; ?></td>
                                                        <td> <?php if(!empty($result['awardedScore'])) { echo $awardedScore[$Details];echo "%"; } else { echo $awardedScore[$Details]; } ?></td>
                                                        <td> <?php if(!empty($result['progress'])) { echo $progress[$Details];echo "%"; } else { echo $progress[$Details]; } ?></td>
                                                        <td> <?php if(!empty($result['timeSpent'])) { echo gmdate("H:i:s", $timeSpent[$Details]); echo "&nbspHrs"; } else { echo $timeSpent[$Details]; } ?></td>
                                                        <?php echo "<br>"; } }?>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6" style="text-align:right;padding-right: 25px;font-weight: 700;font-size: 16px;">Total</td>
                                                        <td><?php echo gmdate("H:i:s", $time); echo "&nbspHrs"; ?>                                                            
                                                        </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="rt-part">
                                <div class="header-view-details">
                                    <p>
                                        <span><i class="fas fa-graduation-cap"></i></span> Overall-Result
                                    </p>
                                </div>
                                ...
                                <div class="student-infos flex">
                                     ...
                                     <div class="btm-cover-right btm-section">
                                        <!--<p class="icon-label"><span >Average</span></p>-->
                                    ...
                                    <div class="btm-cover-left flex">
                                        ...
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">Average</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php $Average=($PassedCourse/$val)*100; echo number_format($Average, 2);echo "%"; $total=100-$Average?></p>
                                            </div>
                                        </div>
                                        <!-- sec-rows -->
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">Total Course</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php echo $val; ?></p>
                                            </div>
                                        </div>
                                        <!-- sec-rows -->
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">Passed Course</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php echo $PassedCourse; ?></p>
                                            </div>
                                        </div>
                                        <!-- sec-rows -->
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">Failed Course</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php echo $FailedCourse; ?></p>
                                            </div>
                                        </div>
                                        <!-- sec-rows -->
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">In Progress Course</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php echo $InProgressCourse; ?></p>
                                            </div>
                                        </div>
                                        <!-- sec-rows -->
                                        <div class="btm-section">
                                            <div class="left">
                                                <p class="label-p">Not Started Course</p>
                                            </div>
                                            <div class="right">
                                                <p class=""><?php echo $NotStartedCourse; ?></p>
                                            </div>
                                        </div>
                                    </div>                                                                                   
                                </div>
